    ...
    return (
        <div className='p-2'>
            <div className='w-full border bg-white  flex flex-col   shadow-md rounded-md'>
                <h2 className=' text-[1rem] font-medium p-6'>Student Complain </h2>
                <Divider />
                <div className="mt-5 overflow-x-auto">
                    <table className="min-w-full  ">
                        <thead>
                            <tr>
                                <th className="px-6 py-3 border-b border-gray-200  text-left text-[0.8rem] text-labelColor leading-4 font-medium   tracking-wider">
                                    Code
                                </th>
                                <th className="px-6 py-3 border-b border-gray-200  text-left text-[0.8rem] text-labelColor  leading-4 font-medium   tracking-wider">
                                    Name
                        ...
                        <tbody>
                            <tr>
                                <td className="px-6 py-4 whitespace-no-wrap  text-textColor border-b border-gray-200">
                                    01
                                </td>
                                <td className="px-6 py-4 whitespace-no-wrap text-textColor border-b border-gray-200">
                                    Jack Ronan
                                ...
                                <td className="px-6 py-4 whitespace-no-wrap border-b text-textColor border-gray-200">
                                    120$
                                </td>
