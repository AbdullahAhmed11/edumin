        ...
        <nav className='w-full p-4 bg-white flex items-center justify-between'>
            ...
            <div className='flex items-center gap-5'>
                <div className='relative'>
                    <BsChatSquareText className=" w-[24px] h-[24px]" />
                    <div className='absolute bg-primary w-[20px] top-[-15px] left-[10px] h-[20px] rounded-full flex items-center justify-center text-white'>
