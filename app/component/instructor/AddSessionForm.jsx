...
const AddSessionForm = () => {
    ...
    return (
        <div className='flex flex-col w-full  bg-white'>
            <h2 className='text-[1.1rem] font-medium p-4'>Add Session
            </h2>
            <Divider />
            <div className='w-full flex flex-col p-4 gap-4'>
                <FormControl className='w-full grid grid-cols-2 gap-3'>
                    ...
                    <div>
                        <FormLabel className='text-labelColor'>Session Types </FormLabel>
                        <Select
                            value={age}
                ...
                <FormControl className='w-full grid grid-cols-2 gap-3'>
                    <div>
                        <FormLabel className='text-labelColor'>Session Start Date
                        </FormLabel>
                        <TextField
                            size="small"
                            type="date"
                    ...
                    <div>
                        <FormLabel className='text-labelColor'>Session End Date
...
"
                ...
                <FormControl className='w-full '>
                    <div className='flex flex-col w-full'>
                        <FormLabel className='text-labelColor'>Session Details</FormLabel>
                        <TextareaAutosize
